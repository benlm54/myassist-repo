#ifndef POSSAMPLESTREAM
#define POSSAMPLESTREAM
...
namespace opennlp
{
    namespace tools
    {
        namespace parser
        {
            ...
            class PosSampleStream : public FilterObjectStream<Parse*, POSSample*>
            {

          public:
              PosSampleStream(ObjectStream<Parse*> *in_Renamed);
