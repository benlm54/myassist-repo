#ifndef NAMEFINDERSEQUENCEVALIDATOR
#define NAMEFINDERSEQUENCEVALIDATOR
...
namespace opennlp
{
    namespace tools
    {
        namespace namefind
        {
            ...
            class NameFinderSequenceValidator : public SequenceValidator<std::string>
            {
...
#endif	//#ifndef NAMEFINDERSEQUENCEVALIDATOR
