#ifndef TOKENCONTEXTGENERATOR
#define TOKENCONTEXTGENERATOR
...
namespace opennlp
{
    namespace tools
    {
        namespace tokenize
        {
          ...
          public:
              virtual std::string *getContext(const std::string &sentence, int index) = 0;
            };
...
#endif	//#ifndef TOKENCONTEXTGENERATOR
