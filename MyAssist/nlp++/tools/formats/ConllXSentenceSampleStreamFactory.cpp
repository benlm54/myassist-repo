...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            std::string ConllXSentenceSampleStreamFactory::getUsage()
            {
              return ArgumentParser::createUsage(Parameters::typeid);
            }

            bool ConllXSentenceSampleStreamFactory::validateArguments(std::string args[])
            {
              return ArgumentParser::validateArguments(args, Parameters::typeid);
            }

            opennlp::tools::util::ObjectStream<SentenceSample*> *ConllXSentenceSampleStreamFactory::create(std::string args[])
            {
