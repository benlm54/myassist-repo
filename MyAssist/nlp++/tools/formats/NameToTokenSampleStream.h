#ifndef NAMETOTOKENSAMPLESTREAM
#define NAMETOTOKENSAMPLESTREAM
...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            /// </summary>
            class NameToTokenSampleStream : public FilterObjectStream<NameSample*, TokenSample*>
            {
...
#endif	//#ifndef NAMETOTOKENSAMPLESTREAM
