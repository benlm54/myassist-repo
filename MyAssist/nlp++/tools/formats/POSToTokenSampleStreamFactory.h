#ifndef POSTOTOKENSAMPLESTREAMFACTORY
#define POSTOTOKENSAMPLESTREAMFACTORY
...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            /// </summary>
            class POSToTokenSampleStreamFactory : public ObjectStreamFactory<TokenSample*>
            {
...
#endif	//#ifndef POSTOTOKENSAMPLESTREAMFACTORY
