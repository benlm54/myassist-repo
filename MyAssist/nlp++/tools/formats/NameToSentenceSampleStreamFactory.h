#ifndef NAMETOSENTENCESAMPLESTREAMFACTORY
#define NAMETOSENTENCESAMPLESTREAMFACTORY
...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            /// </summary>
            class NameToSentenceSampleStreamFactory : public ObjectStreamFactory<SentenceSample*>
            {

          public:
              class Parameters : public NameSampleStreamFactory::Parameters, public DetokenizerParameter
              {
              };
...
#endif	//#ifndef NAMETOSENTENCESAMPLESTREAMFACTORY
