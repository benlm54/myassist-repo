...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            std::string POSToTokenSampleStreamFactory::getUsage()
            {
              return ArgumentParser::createUsage(Parameters::typeid);
            }

            bool POSToTokenSampleStreamFactory::validateArguments(std::string args[])
            {
              return ArgumentParser::validateArguments(args, Parameters::typeid);
            }

            opennlp::tools::util::ObjectStream<TokenSample*> *POSToTokenSampleStreamFactory::create(std::string args[])
            {
