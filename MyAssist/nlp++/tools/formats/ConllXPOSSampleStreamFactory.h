#ifndef CONLLXPOSSAMPLESTREAMFACTORY
#define CONLLXPOSSAMPLESTREAMFACTORY
...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            /// </summary>
            class ConllXPOSSampleStreamFactory : public ObjectStreamFactory<POSSample*>
            {
...
#endif	//#ifndef CONLLXPOSSAMPLESTREAMFACTORY
