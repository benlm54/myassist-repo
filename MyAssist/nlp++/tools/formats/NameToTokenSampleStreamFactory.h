#ifndef NAMETOTOKENSAMPLESTREAMFACTORY
#define NAMETOTOKENSAMPLESTREAMFACTORY
...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            /// </summary>
            class NameToTokenSampleStreamFactory : public ObjectStreamFactory<TokenSample*>
            {
...
#endif	//#ifndef NAMETOTOKENSAMPLESTREAMFACTORY
