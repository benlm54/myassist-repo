#ifndef POSTOSENTENCESAMPLESTREAMFACTORY
#define POSTOSENTENCESAMPLESTREAMFACTORY
...
namespace opennlp
{
    namespace tools
    {
        namespace formats
        {
            ...
            /// </summary>
            class POSToSentenceSampleStreamFactory : public ObjectStreamFactory<SentenceSample*>
            {

          public:
              class Parameters : public WordTagSampleStreamFactory::Parameters, public DetokenizerParameter
              {
              };
...
#endif	//#ifndef POSTOSENTENCESAMPLESTREAMFACTORY
