#ifndef BEAMSEARCHCONTEXTGENERATOR
#define BEAMSEARCHCONTEXTGENERATOR
...
namespace opennlp
{
    namespace tools
    {
        namespace util
        {
            ...
            /// </summary>
            template<typename T>
            class BeamSearchContextGenerator
            {
          ...
          public:
              virtual std::string *getContext(int index, T sequence[], std::string priorDecisions[], Object additionalContext[]) = 0;
            };
...
#endif	//#ifndef BEAMSEARCHCONTEXTGENERATOR
