#ifndef ADAPTIVEFEATUREGENERATOR
#define ADAPTIVEFEATUREGENERATOR
    ...
    namespace tools
    {
        namespace util
        {
            namespace featuregen
            {
              ...
              public:
                  virtual void createFeatures(std::vector<std::string> &features, std::string tokens[], int index, std::string previousOutcomes[]) = 0;
...
#endif	//#ifndef ADAPTIVEFEATUREGENERATOR
