#ifndef INVALIDFORMATEXCEPTION
#define INVALIDFORMATEXCEPTION
...
namespace opennlp
{
    namespace tools
    {
        namespace util
        {
          ...
          private:
              static const long long serialVersionUID = 0;
          ...
          public:
              ...
              InvalidFormatException(const std::string &message, Throwable *t);
            };
...
#endif	//#ifndef INVALIDFORMATEXCEPTION
