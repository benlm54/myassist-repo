#ifndef POSMODELLOADER
#define POSMODELLOADER
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace postag
            {
                ...
                /// </summary>
                class POSModelLoader : public ModelLoader<POSModel*>
                {
              ...
              protected:
                  POSModel *loadModel(InputStream *modelIn) throw(IOException, InvalidFormatException);
                };
