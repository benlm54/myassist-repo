#ifndef TOKENNAMEFINDERMODELLOADER
#define TOKENNAMEFINDERMODELLOADER
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace namefind
            {
                ...
                /// </summary>
                class TokenNameFinderModelLoader : public ModelLoader<TokenNameFinderModel*>
                {
              ...
              protected:
                  TokenNameFinderModel *loadModel(InputStream *modelIn) throw(IOException, InvalidFormatException);
...
#endif	//#ifndef TOKENNAMEFINDERMODELLOADER
