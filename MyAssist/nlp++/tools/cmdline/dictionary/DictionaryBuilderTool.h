#ifndef DICTIONARYBUILDERTOOL
#define DICTIONARYBUILDERTOOL

#include "../tools/cmdline/CmdLineTool.h"
#include "DictionaryBuilderParams.h"
#include <string>
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace dictionary
            {
                ...
                class DictionaryBuilderTool : public CmdLineTool
                {

              public:
                  class Params : public DictionaryBuilderParams
                  {
...
#endif	//#ifndef DICTIONARYBUILDERTOOL
