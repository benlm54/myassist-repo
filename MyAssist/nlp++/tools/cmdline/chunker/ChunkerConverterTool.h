#ifndef CHUNKERCONVERTERTOOL
#define CHUNKERCONVERTERTOOL
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace chunker
            {
                ...
                /// format.
                /// </summary>
                class ChunkerConverterTool : public AbstractConverterTool<ChunkSample*>
                {

              private:
                  static Map<std::string, ObjectStreamFactory<ChunkSample*>*> *const streamFactories;

//JAVA TO C++ CONVERTER TODO TASK: Static constructors are not allowed in native C++:
                  static ChunkerConverterTool();
              ...
              protected:
                  virtual ObjectStreamFactory<ChunkSample*> *createStreamFactory(const std::string &format);
                };
...
#endif	//#ifndef CHUNKERCONVERTERTOOL
