#ifndef CHUNKERCROSSVALIDATORTOOL
#define CHUNKERCROSSVALIDATORTOOL
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace chunker
            {
                ...
                class ChunkerCrossValidatorTool : public CmdLineTool
                {
...
#endif	//#ifndef CHUNKERCROSSVALIDATORTOOL
