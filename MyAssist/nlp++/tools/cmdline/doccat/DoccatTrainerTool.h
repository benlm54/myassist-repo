#ifndef DOCCATTRAINERTOOL
#define DOCCATTRAINERTOOL
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace doccat
            {
                ...
                class DoccatTrainerTool : public CmdLineTool
                {
              ...
              public:
                  ...
                  static ObjectStream<DocumentSample*> *openSampleData(const std::string &sampleDataName, File *sampleDataFile, Charset *encoding);
...
#endif	//#ifndef DOCCATTRAINERTOOL
