#ifndef DETAILEDFMEASUREEVALUATORPARAMS
#define DETAILEDFMEASUREEVALUATORPARAMS
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace params
            {
                ...
                /// </summary>
                class DetailedFMeasureEvaluatorParams
                {
...
#endif	//#ifndef DETAILEDFMEASUREEVALUATORPARAMS
