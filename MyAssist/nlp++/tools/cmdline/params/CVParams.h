...
//JAVA TO C++ CONVERTER TODO TASK: Most Java annotations will not have direct native C++ equivalents:
//ORIGINAL LINE: @ParameterDescription(valueName = "num", description = "The number of folds. Default is 10") @OptionalParameter(defaultValue="10") Integer getFolds();
                  virtual int getFolds() = 0;
