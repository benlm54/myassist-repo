#ifndef TOKENIZERCROSSVALIDATORTOOL
#define TOKENIZERCROSSVALIDATORTOOL
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace tokenizer
            {
                ...
                class TokenizerCrossValidatorTool : public CmdLineTool
                {
...
#endif	//#ifndef TOKENIZERCROSSVALIDATORTOOL
