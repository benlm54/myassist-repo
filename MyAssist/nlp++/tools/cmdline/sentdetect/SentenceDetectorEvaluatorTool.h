#ifndef SENTENCEDETECTOREVALUATORTOOL
#define SENTENCEDETECTOREVALUATORTOOL
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace sentdetect
            {
                ...
                class SentenceDetectorEvaluatorTool : public CmdLineTool
                {
...
#endif	//#ifndef SENTENCEDETECTOREVALUATORTOOL
