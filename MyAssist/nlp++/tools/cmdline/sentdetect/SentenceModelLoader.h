#ifndef SENTENCEMODELLOADER
#define SENTENCEMODELLOADER
    ...
    namespace tools
    {
        namespace cmdline
        {
            namespace sentdetect
            {
                ...
                /// </summary>
                class SentenceModelLoader : public ModelLoader<SentenceModel*>
                {
              ...
              protected:
                  SentenceModel *loadModel(InputStream *modelIn) throw(IOException, InvalidFormatException);
...
#endif	//#ifndef SENTENCEMODELLOADER
