#ifndef BINARYPERCEPTRONMODELWRITER
#define BINARYPERCEPTRONMODELWRITER
...
namespace opennlp
{
    namespace perceptron
    {
        ...
        /// </summary>
        class BinaryPerceptronModelWriter : public PerceptronModelWriter
        {
      public:
          ...
          BinaryPerceptronModelWriter(AbstractModel *model, File *f) throw(IOException);
...
#endif	//#ifndef BINARYPERCEPTRONMODELWRITER
